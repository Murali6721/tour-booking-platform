    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 8:
          _context.prev = 8;
          _context.t0 = _context["catch"](0);
          (0, _alert.showAlert)('error', 'Please check details ');
...
var stripe = Stripe('pk_test_51NyH2mSJ7VAuVC4sndwcSikH4rjO0KWeKL57erOVGbuqlm2RqdHeqUWMPuVcdowcmuHMzfYgVvj8rRR1yrliqelJ00IKgc7lLz');
...
var logOuttn = document.querySelector('.nav__el--logout');
...
if (logOuttn) logOuttn.addEventListener('click', _login.logout);
